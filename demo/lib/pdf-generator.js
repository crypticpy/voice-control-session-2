 ...
 */
export function generatePDF(data, branding) {
  return new Promise((resolve, reject) => {
    try {
      ...
      const appTitle = b.appTitle || "Policy Plain Language Converter";
      const colorPrimary = (b.colors && b.colors.primary) || "#003054";
      const colorAccent = (b.colors && b.colors.accent) || "#007B83";
      ...
      const docDefinition = {
        ...
        content: [
          ...
          {
            text: `\n\nThis report was generated by the ${appTitle}, an AI-assisted tool. This tool assists with — but does not replace — human review.`,
            fontSize: 9,
            color: "#999999",
            alignment: "center",
            italics: true,
